...
public interface PublicationApi {
	...
	@PostMapping
	PublicationDto createPublication(@RequestBody @Validated(OnCreate.class) PublicationDto publicationDto);
	...
	@ResponseStatus(HttpStatus.OK)
	@PutMapping(value = "/{id}")
	PublicationDto updatePublication(@PathVariable long id,
